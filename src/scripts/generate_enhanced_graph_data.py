"""
Generate graph data from enhanced_mock_data directory.

This script transforms enhanced mock CSV data into graph node and edge files
that can be imported into Nebula Graph.
"""
...
ENHANCED_MOCK_DIR = DATA_DIR / "enhanced_mock_data"
ENHANCED_GRAPH_DIR = DATA_DIR / "enhanced_graph_data"
...
class EnhancedGraphDataGenerator:
    ...
    def run(self):
        print(f"Reading data from: {self.mock_dir}")
        print(f"Output directory: {self.graph_dir}")
        self.load_tables()
        self.build_nodes()
        self.build_edges()
        self.write_outputs()
        print(f"\n✓ Enhanced graph data generated successfully in {self.graph_dir}")
    ...
    def load_tables(self):
        ...
        for name, pattern in patterns.items():
            ...
            print(f"  Loaded {name}: {len(self.tables[name])} rows")
    ...
    def _build_person_nodes(self):
        ...
        print(f"  Person nodes: {len(self.person_nodes)}")
    ...
    def _build_company_nodes(self):
        ...
        print(f"  Company nodes: {len(self.company_nodes)}")
    ...
    def _build_contract_nodes(self):
        ...
        print(f"  Contract nodes: {len(self.contract_nodes)}")
    ...
    def _build_legal_event_nodes(self):
        ...
        print(f"  Legal event nodes: {len(self.legal_event_nodes)}")
    ...
    def _build_legal_person_edges(self):
        ...
        print(f"  Legal person edges: {len(self.edges_legal_person)}")
    ...
    def _build_control_edges(self):
        ...
        for row in org_rows:
            ...
            if parent and child:
                ...
                edge_counter += 1
        print(f"  Control edges: {len(self.edges_controls)}")
    ...
    def _build_party_edges(self):
        ...
        for row in contracts:
            ...
            for suffix, id_field, name_field, type_field, label in PARTY_FIELDS:
                ...
                edge_counter += 1
        print(f"  Party edges: {len(self.edges_party)}")
    ...
    def _build_trade_edges(self):
        ...
        for row in contracts:
            ...
            edge_counter += 1
        print(f"  Trade edges: {len(self.edges_trades)}")
        ...
        for row in self.tables["contracts"]:
            ...
            if row.get("FPATYPE") == "bd_customer" and party_a and party_b:
                ...
                if key not in customer_relations:
                    ...
                    customer_counter += 1
        print(f"  Supplier edges: {len(self.edges_is_supplier)}")
        print(f"  Customer edges: {len(self.edges_is_customer)}")
    ...
    def _build_case_edges(self):
        ...
        for row in case_rows:
            ...
            if contract_node:
                ...
                edge_case_contract_counter += 1
        print(f"  Case-person edges: {len(self.edges_case_person)}")
        print(f"  Case-contract edges: {len(self.edges_case_contract)}")
    ...
    def _build_dispute_edges(self):
        ...
        for row in dispute_rows:
            ...
            if contract_node:
                ...
                edge_counter += 1
        print(f"  Dispute-contract edges: {len(self.edges_dispute_contract)}")
        print(f"  Company-transaction edges: {len(self.edges_company_transaction)}")
...
def main():
    generator = EnhancedGraphDataGenerator(ENHANCED_MOCK_DIR, ENHANCED_GRAPH_DIR)
    generator.run()
