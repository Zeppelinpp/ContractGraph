...
# Graph Data Import Script
# This script generates graph data from mock_data and imports it to Nebula Graph
...
echo "======================================"
echo "Graph Data Import Pipeline"
echo "======================================"
echo ""

# Step 1: Generate graph data
echo "Step 1/2: Generating graph data from mock_data..."
echo "--------------------------------------"
...
echo "--------------------------------------"
uv run python src/scripts/nebula_import.py --data-dir graph_data
